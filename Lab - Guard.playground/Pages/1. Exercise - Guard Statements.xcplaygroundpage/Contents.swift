...
print(calculateArea(x: 3.0, y: 5.0))

print(calculateArea(x: -3.0, y: 2.0))
...
func createUser() -> User?{
    guard let fname = firstNameTextField.text, let lname = lastNameTextField.text, let ag = ageTextField.text else {
        return nil
    }
    
    let you = User(firstName: fname, lastName: lname, age: ag)
    return you
}
